/* =========================
   FigurativeWithWordsMark.jsx (FULL UPDATED)
   ✅ Uses Base64 preview so it still shows in Confirmation
========================= */
import React, { useState } from "react";
import "../../Css/TypeOfMarks.css";

export default function FigurativeWithWordsMark({ onNext }) {
    ...
    <div className="tm-modal-body">
      ...
      <div className="tm-field tm-two-col">
        <div>
          ...
          <textarea className="tm-textarea" value={translation} onChange={(e) => setTranslation(e.target.value)} />
        </div>
